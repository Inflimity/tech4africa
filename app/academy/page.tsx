...
export default function AcademyPage() {
    return (
        <>
            ...
            <section id="enroll" className="py-24 px-6 bg-gradient-to-br from-africa-red via-red-600 to-rose-700 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="text-white" data-reveal>
                            ...
                            <h2 className="text-4xl md:text-5xl font-extrabold uppercase tracking-tight leading-tight mb-6">
                                Ready to <br />
                                <span className="text-black/80">Transform</span> <br />
                                Your Future?
                            </h2>
                            <p className="text-rose-100 text-lg leading-relaxed mb-8 max-w-md">
                                Join thousands of African tech professionals who have launched their careers through our intensive programs.
                            </p>
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-sm font-medium">Industry-recognized certifications</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span className="text-sm font-medium">1-on-1 mentorship sessions</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span className="text-sm font-medium">Job placement assistance</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl" data-reveal>
                            <h3 className="text-2xl font-extrabold text-africa-midnight mb-2 uppercase tracking-tight">Enroll Now</h3>
                            <p className="text-slate-500 text-sm mb-8">Fill out the form and we&apos;ll get back to you within 24 hours.</p>

                            <form className="space-y-5">
                                <div>
                                    <label htmlFor="fullName" className="block text-[10px] font-black uppercase tracking-widest text-slate-700 mb-2">Full Name</label>
                                    <input
                                        type="text"
                                        id="fullName"
                                        name="fullName"
                                        placeholder="Enter your full name"
                                        className="w-full px-5 py-4 bg-slate-100 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-africa-red focus:border-transparent transition placeholder:text-slate-400"
                                    />
                                </div>
                                ...
                                <div>
                                    <label htmlFor="course" className="block text-[10px] font-black uppercase tracking-widest text-slate-700 mb-2">Select Course</label>
                                    <select
                                        id="course"
                                        name="course"
                                        className="w-full px-5 py-4 bg-slate-100 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-africa-red focus:border-transparent transition text-slate-700 appearance-none cursor-pointer"
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-[10px] font-black uppercase tracking-widest text-slate-700 mb-2">Message (Optional)</label>
                                    <textarea
                                        id="message"
                                        name="message"
                                        rows={3}
                                        placeholder="Tell us about your goals..."
                                        className="w-full px-5 py-4 bg-slate-100 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-africa-red focus:border-transparent transition placeholder:text-slate-400 resize-none"
                                    />
                                </div>

                                <button
                                    type="submit"
                                    className="w-full bg-gradient-to-r from-africa-red to-rose-600 text-white py-5 rounded-2xl font-black text-xs uppercase tracking-widest hover:from-africa-midnight hover:to-slate-800 transition-all duration-300 shadow-lg shadow-africa-red/30 hover:shadow-slate-900/30 active:scale-[0.98]"
                                >
                                    Submit Application
                                </button>
                            </form>
                            ...
                            <p className="text-center text-[10px] text-slate-400 mt-6">
                                By submitting, you agree to our <Link href="/terms" className="text-africa-red hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-africa-red hover:underline">Privacy Policy</Link>.
                            </p>
                        </div>
                    </div>
                </div>
